...
public class LevelList {
	public static LevelConfiguration[] levels = new LevelConfiguration[] {
			...
			new LevelConfiguration(3,.25,200, Biome.getBiome("Forest")),
			new LevelConfiguration(3,.25,200, Biome.getBiome("Mars")),
			new LevelConfiguration(4,.30,200, Biome.getBiome("Mars")),
			new LevelConfiguration(4,.30,200, Biome.getBiome("Mars")),
			...
			new LevelConfiguration(6,.30,200, Biome.getBiome("Random")),
			new LevelConfiguration(7,.30,200, Biome.getBiome("Random"))
	};
